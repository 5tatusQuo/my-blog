...
lastmod: '2019-12-01T00:00:00.000Z'
draft: false
tags: ['crackme', 'reverse-engineering', 'ringzer0', 'ollydbg', 'ida', 'x86', 'windows-api']
authors: ['default']
summary: 'Walkthrough of two Ringzer0 challenges: "Windows x86 reversing is cool" and "Windows API for the win", demonstrating reverse engineering techniques on Windows executables.'
---
...
![Wrong Key Message](/static/images/blog/crackme-4-5-1.png)
...
![IDA Key Function](/static/images/blog/crackme-4-5-2.png)

As above, it looks like our key will need to be at a length of 6 otherwise "Wrong Key!" is returned.

![Length Check](/static/images/blog/crackme-4-5-3.png)
...
![Debug Session](/static/images/blog/crackme-4-5-4.png)
...
![Register Comparison](/static/images/blog/crackme-4-5-5.png)
...
![Correct Key](/static/images/blog/crackme-4-5-6.png)
...
![Password Function](/static/images/blog/crackme-4-5-7.png)
...
![Second Function](/static/images/blog/crackme-4-5-8.png)
...
![Password Bytes](/static/images/blog/crackme-4-5-9.png)
...
![Notepad View](/static/images/blog/crackme-4-5-10.png)
...
![Modified Instruction](/static/images/blog/crackme-4-5-11.png)

After we step over the modified instruction, let's see what happens when we execute the rest of the program:

![Final Result](/static/images/blog/crackme-4-5-12.png)
