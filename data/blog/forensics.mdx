...
authors: ['default']
summary: 'Walkthrough of TryHackMe\'s Forensics challenge using Volatility framework for memory analysis and malware detection.'
---
...
![Shellbags Analysis](/static/images/blog/forensics-1.png)
