...
lastmod: '2020-01-11T00:00:00.000Z'
draft: false
tags: ['ctf', 'picoctf', 'reverse-engineering', 'java', 'cryptography']
authors: ['default']
summary: 'Walkthrough of the picoCTF Vault Door series challenges, demonstrating reverse engineering techniques on Java applications.'
---
...
![VaultDoor3 Solution](/static/images/blog/picoctf-vault-door-1.png)
...
![URL Decoding Result](/static/images/blog/picoctf-vault-door-2.png)
