...
authors: ['default']
summary: 'Walkthrough of Saduz\'s Visual C++ crackme challenge, demonstrating reverse engineering techniques and keygen development.'
---
...
![Crackme Interface](/static/images/blog/crackme-2-1.png)

We try "test" as our Name and "123" as our Reg num, but a MessageBox is spawned asking us to try again.

![Try Again Message](/static/images/blog/crackme-2-2.png)
...
![Username Processing](/static/images/blog/crackme-2-3.png)
...
![Name Processing](/static/images/blog/crackme-2-4.png)
...
![Registration Number Comparison](/static/images/blog/crackme-2-5.png)
...
![Keygen Result](/static/images/blog/crackme-2-6.png)
