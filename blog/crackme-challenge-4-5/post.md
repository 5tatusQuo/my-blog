---
title: "Crackme Challenge #4 & #5 - Windows x86 Reversing & Windows API"
date: "1 Dec 2019"
description: "Walkthrough of two Ringzer0 challenges: \"Windows x86 reversing is cool\" and \"Windows API for the win\", demonstrating reverse engineering techniques on Windows executables."
tags: [crackme, reverse-engineering, ringzer0, ollydbg, ida, x86, windows-api]
---
...
![Wrong Key Message](../../static/images/blog/crackme-4-5-1.png "Wrong Key Message")
...
![IDA Key Function](../../static/images/blog/crackme-4-5-2.png "IDA Key Function")

As above, it looks like our key will need to be at a length of 6 otherwise "Wrong Key!" is returned.

![Length Check](../../static/images/blog/crackme-4-5-3.png "Length Check")
...
![Debug Session](../../static/images/blog/crackme-4-5-4.png "Debug Session")
...
![Register Comparison](../../static/images/blog/crackme-4-5-5.png "Register Comparison")
...
![Correct Key](../../static/images/blog/crackme-4-5-6.png "Correct Key")
...
![Password Function](../../static/images/blog/crackme-4-5-7.png "Password Function")
...
![Second Function](../../static/images/blog/crackme-4-5-8.png "Second Function")
...
![Password Bytes](../../static/images/blog/crackme-4-5-9.png "Password Bytes")
...
![Notepad View](../../static/images/blog/crackme-4-5-10.png "Notepad View")
...
![Modified Instruction](../../static/images/blog/crackme-4-5-11.png "Modified Instruction")

After we step over the modified instruction, let's see what happens when we execute the rest of the program:

![Final Result](../../static/images/blog/crackme-4-5-12.png "Final Result")
