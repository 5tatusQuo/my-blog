...
date: "25 Sept 2019"
description: "Walkthrough of 7eRoM Crackme challenge #1, demonstrating reverse engineering techniques and anti-debugging bypass methods."
...
![Password Prompt](../../static/images/blog/crackme-1-1.png "Password Prompt")
...
![Debug Output](../../static/images/blog/crackme-1-2.png "Debug Output")

### Finding the main function

When viewing this app in Ollydbg, we are greeted with the C runtime initialization (CRT) system. According to [https://www.embecosm.com/appnotes/ean9/html/ch05s02.html,](https://www.embecosm.com/appnotes/ean9/html/ch05s02.html,) a few initialization steps need to be taken before calling the main function.
...
![IDA Graph View](../../static/images/blog/crackme-1-3.png "IDA Graph View")
...
![Referenced Strings](../../static/images/blog/crackme-1-4.png "Referenced Strings")
...
![Ghidra Decompilation 1](../../static/images/blog/crackme-1-5.png "Ghidra Decompilation 1")

![Ghidra Decompilation 2](../../static/images/blog/crackme-1-6.png "Ghidra Decompilation 2")
...
![Password Check Logic](../../static/images/blog/crackme-1-7.png "Password Check Logic")
...
![Anti-Debug Check](../../static/images/blog/crackme-1-8.png "Anti-Debug Check")

According to [https://en.wikipedia.org/wiki/Win32_Thread_Information_Block,](https://en.wikipedia.org/wiki/Win32_Thread_Information_Block,) offset 0x18 is the linear address of the thread environment block (TEB) and offset 0x30 is the linear address of the process environment block (PEB). Offset 0x2 from the PEB points to an interesting discovery:
...
![Patched Anti-Debug](../../static/images/blog/crackme-1-9.png "Patched Anti-Debug")
...
![Password in Memory](../../static/images/blog/crackme-1-10.png "Password in Memory")
...
![Success Message](../../static/images/blog/crackme-1-11.png "Success Message")

I think we know what the password is. Let's execute the Crackme without running the debugger and give it a go:

![Final Result](../../static/images/blog/crackme-1-12.png "Final Result")
