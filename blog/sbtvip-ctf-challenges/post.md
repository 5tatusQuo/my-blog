---
title: "SBTVIP CTF Challenges - Network Analysis, Password Cracking & Forensics"
date: "29 Feb 2020"
description: "Walkthrough of various SBTVIP CTF challenges including ICMP data exfiltration, password cracking with leetspeak, and PNG file repair techniques."
tags: [ctf, network-analysis, password-cracking, forensics, wireshark, scapy, png-analysis]
---
...
As the CTF is still open and very much active, I will not be revealing the flags. As such, I will showcase the methods I used to retrieve these flags for my favourite challenges. If you wish to have a go, visit [https://sbtvip.ctfd.io/challenges,](https://sbtvip.ctfd.io/challenges,) make an account and get going!
...
![Wireshark ICMP Analysis](../../static/images/blog/sbtvip-1.png "Wireshark ICMP Analysis")
...
![ICMP Payload Analysis](../../static/images/blog/sbtvip-2.png "ICMP Payload Analysis")
...
![Frame 13 Analysis](../../static/images/blog/sbtvip-3.png "Frame 13 Analysis")

![Frame 14 Analysis](../../static/images/blog/sbtvip-4.png "Frame 14 Analysis")

![Frame 15 Analysis](../../static/images/blog/sbtvip-5.png "Frame 15 Analysis")

![Frame 16 Analysis](../../static/images/blog/sbtvip-6.png "Frame 16 Analysis")
...
> I've found a hash of the password for the domain controller. 01F3273F68195C29A1A2365BE7AD2B1AAD469A73
>
    ...
    for word in fin:
        ...
        for first_hex_digit in string.hexdigits:
            for last_hex_digit in string.hexdigits:
                ...
                target_hash = '01F3273F68195C29A1A2365BE7AD2B1AAD469A73'		
                sha = hashlib.sha1(hex_text.encode('utf-8')).hexdigest()
                if sha.upper() ==  target_hash.upper():
...
PIG is not a valid magic number, but the IHDR chunk indicates this is a PNG file. We can find the PNG file structure documentation here: [http://www.libpng.org/pub/png/spec/1.2/PNG-Chunks.html](http://www.libpng.org/pub/png/spec/1.2/PNG-Chunks.html)
...
![IPAD Chunk Search](../../static/images/blog/sbtvip-7.png "IPAD Chunk Search")
...
![File End Analysis](../../static/images/blog/sbtvip-8.png "File End Analysis")
...
![ZIP Archive](../../static/images/blog/sbtvip-9.png "ZIP Archive")
...
![Floppy Disk Image](../../static/images/blog/sbtvip-10.png "Floppy Disk Image")
...
![Hex Comparison](../../static/images/blog/sbtvip-11.png "Hex Comparison")
