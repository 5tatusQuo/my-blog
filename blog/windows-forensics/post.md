---
title: "Windows Forensics - Lateral Movement & Persistence Analysis"
date: "8 June 2025"
description: "Analysis of Windows forensics challenge involving lateral movement and persistence techniques, demonstrating DFIR tools and methodologies."
tags: [forensics, windows, dfir, lateral-movement, persistence, rdp-analysis]
---
...
The challenge is marked as HARD by LetsDefend: [https://app.letsdefend.io/challenge/windows-forensics](https://app.letsdefend.io/challenge/windows-forensics)
...
![Drive Mounting](../../static/images/blog/windows-forensics-1.png "Drive Mounting")

![Root Directory](../../static/images/blog/windows-forensics-2.png "Root Directory")
...
![Shellbags Analysis](../../static/images/blog/windows-forensics-3.png "Shellbags Analysis")
...
![Recycle Bin Analysis](../../static/images/blog/windows-forensics-4.png "Recycle Bin Analysis")
...
![Prefetch Analysis](../../static/images/blog/windows-forensics-5.png "Prefetch Analysis")
...
Found this on MACB Timestamps: [https://cscclabs.medium.com/mac-b-timestamps-86b40d7e7144](https://cscclabs.medium.com/mac-b-timestamps-86b40d7e7144)
...
![MFT Analysis](../../static/images/blog/windows-forensics-6.png "MFT Analysis")
...
[https://learn.microsoft.com/en-us/windows-hardware/drivers/debugger/gflags-details](https://learn.microsoft.com/en-us/windows-hardware/drivers/debugger/gflags-details)

![GlobalFlags Registry](../../static/images/blog/windows-forensics-7.png "GlobalFlags Registry")

![Silent Process Exit](../../static/images/blog/windows-forensics-8.png "Silent Process Exit")
...
![Persistence Registry](../../static/images/blog/windows-forensics-9.png "Persistence Registry")
...
Found this: [https://medium.com/@ronald.craft/blind-forensics-with-the-rdp-bitmap-cache-16e0c202f91c](https://medium.com/@ronald.craft/blind-forensics-with-the-rdp-bitmap-cache-16e0c202f91c)
...
Researching more on the format of this command and what it's doing led me to this page: [https://bherunda.medium.com/hunting-named-pipe-token-impersonation-abuse-573dcca36ae0](https://bherunda.medium.com/hunting-named-pipe-token-impersonation-abuse-573dcca36ae0)
