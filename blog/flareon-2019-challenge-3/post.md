...
date: "6 Oct 2019"
description: "Walkthrough of Flare-on 2019 challenge #3 - Memecat Battlestation, demonstrating .NET reverse engineering techniques using dnSpy."
...
![Game Interface](../../static/images/blog/flareon-2019-1.png "Game Interface")
...
![dnSpy Analysis](../../static/images/blog/flareon-2019-2.png "dnSpy Analysis")

We turn our attention to the FireButton_Click function. Immediately, we find the required code to fire the weapon:

![FireButton Click Function](../../static/images/blog/flareon-2019-3.png "FireButton Click Function")
...
![isValidWeaponCode Function](../../static/images/blog/flareon-2019-4.png "isValidWeaponCode Function")
...
![Hex to ASCII Conversion](../../static/images/blog/flareon-2019-5.png "Hex to ASCII Conversion")

We enter our code into the Stage2Form TextBox and retrieve our flag:

![Final Flag](../../static/images/blog/flareon-2019-6.png "Final Flag")
